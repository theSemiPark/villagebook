...
<body bgcolor="white" text="black" oncontextmenu='return false'>
	...
	<h2>
	<br>
		<font color="#333333">사용법 안내</font>
	</h2>
	<br><br>
	<a href = "wayUserRental.jsp"><img src="img/rental.png" width="200px"></a>   <a href = "wayUserReturn.jsp"><img src="img/return.png" width="200px"></a>   <a href = "wayUserMileage.jsp"><img src="img/mileage.png" width="200px"></a>
	<footer id="footer">
		<div id="footer_box">
			<c:choose>
