...
<body>
	...
	<h2>대여 현황</h2>
	<form action="deliveryList.jsp" method="post">
		<table class="upper">
	...
	<table class="list">
		...
		<c:if test="${boardList == '[]' }"><tr><td colspan=5>대여 중인 내역이 없습니다</td></tr></c:if>
		<c:forEach items="${boardList }" var="board">
			<tr align="center">
				<td><a href="delivery.do?ordid=${board.ordid }">${board.ordid }</a></td>
